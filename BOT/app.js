...
const flowBarcelona = addKeyword(['👉 En Barcelona','tienda en Barcelona','tienda de barcelona','estoy en Barcelona','desde barcelona','de barcelona','de hospitalet','desde hospitalet','vivo en barcelona'])
    .addAnswer(['Estamos ubicados en','Carrer dels Rajolers, 8','*Horario*', 'De lunes a viernes de 5:00 a 8:00 pm','Sábados de 4:00 a 7:00 pm'])
    .addAnswer('🗓️🕒 Atendemos *solo con cita previa*!',{delay: 6000,})
    .addAnswer(['Puedes pedir una cita aquí:','www.citas.vestidos15.es'],{delay: 7000,})

const flowTiempo = addKeyword(['cuanto tiempo','cuánto tiempo', 'meses antes', 'semanas antes','cuánto tiempo antes','cuanto tiempo antes'])
...
const flowRecoger = addKeyword(['buscar el vestido'])
...
//2 Servicios
const flowServicios = addKeyword(['Servicios','servicio','quiero información', 'quiero informacion','queria informacion','quería informacion','quería información','tienen','necesito','este vestido','este estilo','solo por un dia','estoy buscando un','estoy buscando una','Tienen vestidos','fb.me','https://fb','bestido','Cumplo quince años','fotos de los vestidos','ocupo','interesad','pedir cita','una cita','una sita','pedir sita','o más información', 'o más informacion','o mas información', 'o mas informacion','a más informacion','a más informacion','a mas información','a mas informacion'])
...
const flowAlquiler = addKeyword(['funciona el alquiler','explicar el alquiler'])
...
const flowTallas = addKeyword(['su talla','la talla del vestido','talla de','le queda','le queda el vestido','le quedara el vestido','ajusta','corset','corse','medidas'])
...
const flowDamas = addKeyword(['vestidos de dama','vestidos cortos'])
...
const flowCatalogo = addKeyword(['tienen catálogo','tienen catalogo','el catálogo','el catalogo'])
